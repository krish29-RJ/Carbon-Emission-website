...
export default function CategoryBreakdownChart({ data, total }: Props) {
  return (
    <div className="glass-card rounded-2xl p-6 shadow-sm">
      ...
      <p className="text-xs text-slate-400 mb-4 font-medium">Breakdown by category</p>
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
          <span className="text-3xl font-extrabold text-white leading-none mb-1">{total}</span>
          <span className="text-[10px] text-slate-400 font-semibold uppercase tracking-wider">kg CO₂e/mo</span>
        </div>
      </div>
