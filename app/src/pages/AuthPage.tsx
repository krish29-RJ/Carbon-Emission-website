      ...
      <div className="flex-1 flex items-center justify-center bg-white px-4 py-12 light text-foreground">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-2 mb-8 justify-center">
            ...
            <span className="text-xl font-bold text-emerald-900">CarbonWise</span>
          </div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
                    ...
                    <div className="flex-1">
                      ...
                      {error.toLowerCase().includes('email not confirmed') && (
                        <p className="text-xs text-red-500 mt-1.5 leading-relaxed">
                          <strong>How to solve:</strong> Check your inbox (and spam folder) for a confirmation link. 
                          If you want to disable email confirmation for local testing, go to your 
                          <span className="font-semibold"> Supabase Dashboard &rarr; Authentication &rarr; Providers &rarr; Email</span> and toggle off <strong>Confirm email</strong>.
                        </p>
                      )}
                    </div>
                  </div>
              ...
              >
                Try the demo: <span className="font-medium">demo@carbonwise.app / password</span>
              </button>
            </motion.div>
          </AnimatePresence>
        </div>
